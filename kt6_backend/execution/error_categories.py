...
_CATEGORY_RULES: tuple[tuple[str, str], ...] = (
    ...
    ("browser_click_", EXECUTION_FAILED),
    ("browser_double_click_", EXECUTION_FAILED),
    ("browser_input_", EXECUTION_FAILED),
    ("browser_key_", EXECUTION_FAILED),
    ("browser_scroll_", EXECUTION_FAILED),
    ("browser_select_", EXECUTION_FAILED),
    ...
    ("scenario_select_", EXECUTION_FAILED),
